...
public class AmazonDataProvider {
	...
	public static Object[][] getTestData() {
		int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "AmazonTaskData");
		int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "AmazonTaskData");
		Object[][] workflowdata = new Object[noofrows][noofcols];

		for (int i = 1; i <= noofrows; i++) {
			String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "AmazonTaskData", i);
