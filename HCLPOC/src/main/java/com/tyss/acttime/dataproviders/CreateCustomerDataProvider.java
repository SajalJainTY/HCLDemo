 ...
 * @author Sajal jain
 */
public class CreateCustomerDataProvider {
	/**
	...
	public static Object[][] getTestData() {
		int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "CreateCustomer");
		int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "CreateCustomer");
		Object[][] workflowdata = new Object[noofrows][noofcols];

		for (int i = 1; i <= noofrows; i++) {
			String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "CreateCustomer", i);
