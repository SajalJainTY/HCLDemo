 ...
 * @author Sajal jain
 */
public class EaseMyTripDataProvider {
	/**
	...
	public static Object[][] getTestData() {
		int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "EaseMyTripData");
		int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "EaseMyTripData");
		Object[][] workflowdata = new Object[noofrows][noofcols];

		for (int i = 1; i <= noofrows; i++) {
			String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "EaseMyTripData", i);
