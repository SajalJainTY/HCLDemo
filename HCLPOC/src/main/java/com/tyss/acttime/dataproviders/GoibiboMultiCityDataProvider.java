...
* @author Sajal jain
*/
public class GoibiboMultiCityDataProvider {
		/**
		...
		public static Object[][] getTestData() {
			int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "GoibiboMultiCityData");
			int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "GoibiboMultiCityData");
			Object[][] workflowdata = new Object[noofrows][noofcols];

			for (int i = 1; i <= noofrows; i++) {
				String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "GoibiboMultiCityData", i);
