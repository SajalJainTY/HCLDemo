 ...
 * @author Sajal jain
 */
public class JustDialDataProvider {
			/**
			...
			public static Object[][] getTestData() {
				int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "JustDialData");
				int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "JustDialData");
				Object[][] workflowdata = new Object[noofrows][noofcols];

				for (int i = 1; i <= noofrows; i++) {
					String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "JustDialData", i);
