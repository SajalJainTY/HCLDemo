 ...
 * @author Sajal jain
 */
public class JustDialHotelsDataProvider {
		/**
		...
		public static Object[][] getTestData() {
			int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "JustDialHotelsData");
			int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "JustDialHotelsData");
			Object[][] workflowdata = new Object[noofrows][noofcols];

			for (int i = 1; i <= noofrows; i++) {
				String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "JustDialHotelsData", i);
