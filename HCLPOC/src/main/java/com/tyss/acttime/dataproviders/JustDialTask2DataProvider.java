 ...
 * @author Sajal jain
 */
public class JustDialTask2DataProvider {
	/**
	...
	public static Object[][] getTestData() {
		int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "JustDialTask2Data");
		int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "JustDialTask2Data");
		Object[][] workflowdata = new Object[noofrows][noofcols];

		for (int i = 1; i <= noofrows; i++) {
			String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "JustDialTask2Data", i);
