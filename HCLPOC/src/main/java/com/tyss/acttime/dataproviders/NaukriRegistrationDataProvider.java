 ...
 * @author Sajal jain
 */
public class NaukriRegistrationDataProvider {
	/**
	...
	public static Object[][] getTestData() {
		int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "NaukriRegistraionData");
		int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "NaukriRegistraionData");
		Object[][] workflowdata = new Object[noofrows][noofcols];

		for (int i = 1; i <= noofrows; i++) {
			String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "NaukriRegistraionData", i);
