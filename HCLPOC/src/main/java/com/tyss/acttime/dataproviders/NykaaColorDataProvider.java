 ...
 * @author Sajal jain
 */
public class NykaaColorDataProvider {
		/**
		...
		public static Object[][] getTestData() {
			int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "NykaaColorData");
			int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "NykaaColorData");
			Object[][] workflowdata = new Object[noofrows][noofcols];

			for (int i = 1; i <= noofrows; i++) {
				String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "NykaaColorData", i);
