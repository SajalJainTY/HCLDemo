 ...
 * @author Sajal jain
 */
public class RelianceDigitalDataProvider {
		/**
		...
		public static Object[][] getTestData() {
			int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "RelianceDigitalData");
			int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "RelianceDigitalData");
			Object[][] workflowdata = new Object[noofrows][noofcols];

			for (int i = 1; i <= noofrows; i++) {
				String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "RelianceDigitalData", i);
