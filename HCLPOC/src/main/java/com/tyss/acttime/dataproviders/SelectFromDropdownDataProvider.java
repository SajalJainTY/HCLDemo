...
* @author Sajal jain
*/
public class SelectFromDropdownDataProvider {
	/**
	...
	public static Object[][] getTestData() {
		int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "SelectFromDropdown");
		int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "SelectFromDropdown");
		Object[][] workflowdata = new Object[noofrows][noofcols];

		for (int i = 1; i <= noofrows; i++) {
			String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "SelectFromDropdown", i);
