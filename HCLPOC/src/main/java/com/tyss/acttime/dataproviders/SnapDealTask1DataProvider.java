 ...
 * @author Sajal jain
 */
public class SnapDealTask1DataProvider {
	/**
	...
	public static Object[][] getTestData() {
		int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "SnapDealTask1Data");
		int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "SnapDealTask1Data");
		Object[][] workflowdata = new Object[noofrows][noofcols];

		for (int i = 1; i <= noofrows; i++) {
			String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "SnapDealTask1Data", i);
